...
public sealed class TimeSyncServer : MonoBehaviour
{
    ...
    [SerializeField] private int syncPort = YubiWireProtocol.TimeSyncPort;
    ...
    private void OnRequest(IAsyncResult ar)
    {
        ...
        if (YubiWireProtocol.TryParseTimeSyncRequest(request, out long t1PcNs))
        {
            ...
            byte[] response =
                YubiWireProtocol.EncodeTimeSyncResponse(t1PcNs, t2QuestNs);
            try
            {
