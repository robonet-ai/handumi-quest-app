...
/// </summary>
public static class YubiCompatibilityBuild
{
    public const string ScenePath =
        "Assets/YubiQuestApp/Scenes/YubiQuestCompatibility.unity";
    public const string DefaultApkPath =
        "Builds/Android/handumi-quest-app-v0.1.0.apk";
    ...
    private const string GeneratedUiMaterialPath =
        "Assets/YubiQuestApp/Generated/HandUMIStatusText.mat";

    private const string OriginalApkSha256 =
        "1af91c35e0476b629d85f87bed33667a37b08ecba934596f8420069ab7174";

    [MenuItem("Tools/YubiQuest/Rebuild Compatibility Scene")]
    public static void RebuildCompatibilityScene()
    {
        ConfigureYubiQuestProject.Apply();
        EnsureFolder("Assets/YubiQuestApp/Scenes");

        Scene scene = EditorSceneManager.NewScene(
            NewSceneSetup.EmptyScene,
            NewSceneMode.Single);
        scene.name = "YubiQuestCompatibility";
        ...
        GameObject services = new GameObject("YubiQuestServices");
        ...
        Debug.Log($"[YubiQuest] Rebuilt compatibility scene: {ScenePath}");
    }
    ...
    private static void MakeFallbackMaterialsUrpCompatible(
        ...
        Shader controllerShader)
    {
        EnsureFolder("Assets/YubiQuestApp/Generated");
        ...
        for (int rendererIndex = 0; rendererIndex < renderers.Length; ++rendererIndex)
        {
            ...
            for (int materialIndex = 0; materialIndex < materials.Length; ++materialIndex)
            {
                ...
                string path =
                    $"Assets/YubiQuestApp/Generated/{controllerName}-" +
    ...
    [MenuItem("Tools/YubiQuest/Build Compatibility APK")]
    public static void BuildAndroid()
    {
        ...
        string requestedPath = Environment.GetEnvironmentVariable("YUBI_APK_OUTPUT");
        ...
        Debug.Log(
            $"[YubiQuest] Built {outputPath} ({report.summary.totalSize} bytes, sha256={sha256})");
    }
        ...
        BuildReport report)
    {
        ...
        {
            schema = "yubi_quest_compatibility_build_v1",
